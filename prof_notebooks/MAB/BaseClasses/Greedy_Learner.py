...
class Greedy_Learner(Learner):
    ...
    def pull_arm(self):
        # The greedy learner samples by maximizing the expected reward. 
        # But, we want that all the arms are sampled at least once        
    ...
    def update(self, pulled_arm, reward):
        ...
        # Weighted mean of the collected rewards
