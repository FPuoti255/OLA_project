...
from BaseClasses.Non_stationary_Environment import *
from BaseClasses.TS_Learner import *
from BaseClasses.SWTS_Learner import *
...
if __name__ == '__main__':
    ...
    for i in range(n_phases):
        ...
        ts_instantaneous_regret[t_index] = opt_per_phases[i] - np.mean(ts_rewards_per_experiment, axis = 0)
        swts_instantaneous_regret[t_index] = opt_per_phases[i] - np.mean(swts_rewards_per_experiment, axis = 0)
