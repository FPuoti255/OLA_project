...
for i in range(0, n_obs):
    ...
    #----Using GP----
    # First good practice is to normalize the data, but in our case all the data is between 0 and 1
    
    #converting the shapes of X
    ...
    # we now plot the uncertainty with 95% of confidence
